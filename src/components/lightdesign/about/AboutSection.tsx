            ...
            <div className="aboutcontainer">
                ...
                <div className="aboutdescriptioncontainer">
                    ...
                    <p>
                        ...
                        <br />
                        Backed by <span>Agile and SAFe Agile methodologies</span>, I bring extensive experience managing both Agile and Waterfall projects, <span>cultivating client relationships, and leading high-performing teams.</span>
                        <br />
                        My career spans domains including <span>Banking (Digital, Web & Mobile Apps, Payments & Cards, Retail Tools), Land Information Management, Health Insurance, and Telecom</span>, showcasing versatility in complex environments.
                        <br /><br />
                        <DownloadResumeButton buttonTitle="Feel free to download my resume for more information." showIcon={false} />
                    </p>
